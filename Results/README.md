...
| Seurat WNN  | single-cell multi-omics | [Source]([Integrated analysis of multimodal single-cell data: Cell](https://www.cell.com/cell/fulltext/S0092-8674(21)00583-3) |
|   MultiVI   | single-cell multi-omics | [Source]([MultiVI: deep generative model for the integration of multimodal data) |
